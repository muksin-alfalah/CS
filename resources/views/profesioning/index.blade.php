...
$(document).ready(function(){
 ...
 function fetch_data()
 {
  $.ajax({
   ...
   success:function(data)
   {
    var html = '';
    html += '<tr>';
    html += '<td contenteditable="true" id="no_sc"></td>';
 ...
 $(document).on('click', '#add', function(){
  ...
  {
   $.ajax({
    url:"{{ route('profesioning.add_data') }}",
    method:"POST",
 ...
 $(document).on('blur', '.column_name', function(){
  ...
  {
   $.ajax({
    url:"{{ route('profesioning.update_data') }}",
    method:"POST",
 ...
 $(document).on('click', '.delete', function(){
  ...
  {
   $.ajax({
    url:"{{ route('profesioning.delete_data') }}",
    method:"POST",
