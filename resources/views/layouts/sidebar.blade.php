<ul class="nav">
          ...
          <li class="nav-item {{ setActive(['profesioning*','user*']) }}">
            <a class="nav-link " data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-content-copy"></i>
              <span class="menu-title">Master Data</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ setShow(['profesioning*','user*']) }}" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link {{ setActive(['profesioning*']) }}" href="{{route('profesioning.index')}}">Input Data</a>
                </li>
                 <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-laporan">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="{{url('laporan/trs')}}">Laporan</a>
                </li>
              </ul>
            </div>
          </li>
